...
export default class DataTransform extends BaseKDDComponent {
    constructor() {
        super(...arguments);
        this.name = 'Transformación de datos';
        this.className = 'DataTransform';
    }
    initialize() {
    ...
    transformExamine() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isExamining || this.state.hasExaminedDataset)
                return;
            ...
            this.registerAction('Se examinó el conjunto de datos', 'transformExamine', { hasExaminedDataset, datatypes, rowAmmount, columnAmmount, correlation });
            this.isExamining = false;
        });
    }
    transformEdit() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isEditing || !this.state.hasExaminedDataset || this.state.datatypes === null)
                return;
            this.isEditing = true;
            const areValid = yield this.checkPrerequisitesMet(300, 600);
            if (!areValid) {
    ...
    transformFilter() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isFiltering || !this.state.hasExaminedDataset || this.state.rowAmmount === null)
                return;
    ...
    transformReduce() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isReducing || !this.state.hasExaminedDataset || this.state.columnAmmount === null)
                return;
            ...
            let newColumnAmmount;
            let newCorrelation = null, correlationChangeDescription = '';
